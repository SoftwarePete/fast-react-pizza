      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && ( // TODO: hide error onChange if there is one
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            <input
              ...
              required
            />
            {addressStatus === "error" && ( // TODO: hide error onChange if there is one
              <p className="mt-2 whitespace-pre-wrap rounded-md bg-red-100 p-2 text-xs text-red-700">
                {errorAddress}
              </p>
            )}
          </div>
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[3px] z-50 md:right-[5px] md:top-[5px]">
              {/* TODO: button jumps out of field on mobile */}
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
